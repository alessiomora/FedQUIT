...
do
    echo "$i"
    python -m federated_fedquit.main_fl dataset="cifar10" alpha=0.3 retraining=False
done
...
do
  ...
  do
    echo "$i"
    python -m federated_fedquit.main_fl seed=2 dataset="cifar10" alpha=0.3 retraining=True unlearned_cid=$i
  done
done

## running unlearning routine for each client (logit is logit_zero in the paper, and softmax is softmax_min in the paper)
python -m federated_fedquit.unlearning_routine dataset="cifar10" alpha=0.3 algorithm="incorrect" unlearning_epochs=20 learning_rate_unlearning=1e-05 local_batch_size=32
python -m federated_fedquit.unlearning_routine dataset="cifar10" alpha=0.3 algorithm="projected_ga" unlearning_epochs=5 learning_rate_unlearning=1e-02 projected_ga.early_stopping_threshold=6.0 local_batch_size=512
python -m federated_fedquit.unlearning_routine dataset="cifar10" alpha=0.3 algorithm="softmax" unlearning_epochs=20 learning_rate_unlearning=1e-05 local_batch_size=32
python -m federated_fedquit.unlearning_routine dataset="cifar10" alpha=0.3 algorithm="softmax_zero" unlearning_epochs=20 learning_rate_unlearning=1e-05 local_batch_size=32
python -m federated_fedquit.unlearning_routine dataset="cifar10" alpha=0.3 algorithm="logit" unlearning_epochs=20 learning_rate_unlearning=1e-05 local_batch_size=32
python -m federated_fedquit.unlearning_routine dataset="cifar10" alpha=0.3 algorithm="logit_min" unlearning_epochs=20 learning_rate_unlearning=1e-05 local_batch_size=32
